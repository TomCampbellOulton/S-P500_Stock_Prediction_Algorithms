...
def main(START_DATE="2010-01-01", END_DATE="2025-12-31", DATA_SPLIT_RATIOS=(0.8, 0.1, 0.1), N_STEPS=5, rmse_mode="price"):
    ...
    # Scalers are only fit onto training data - avoid leakage
    ...
    features_seq, labels_seq = create_sequences(features_scaled, labels_scaled, SEQUENCE_LENGTH, N_STEPS)
